...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lbl_logo = QLabel(self.frame_sidebar)
        self.lbl_logo.setObjectName(u"lbl_logo")
        self.lbl_logo.setMinimumSize(QSize(70, 60))
        ...
        font.setBold(True)
        self.lbl_page_title.setFont(font)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lbl_logo.setText(QCoreApplication.translate("MainWindow", u"MTS", None))
        self.btn_nav_test.setText(QCoreApplication.translate("MainWindow", u"T", None))
        self.lbl_nav_test.setText(QCoreApplication.translate("MainWindow", u"Test Dashboard", None))
        self.btn_nav_logs.setText(QCoreApplication.translate("MainWindow", u"L", None))
        self.lbl_nav_logs.setText(QCoreApplication.translate("MainWindow", u"System Logs", None))
        self.btn_nav_debug.setText(QCoreApplication.translate("MainWindow", u"D", None))
        self.lbl_nav_debug.setText(QCoreApplication.translate("MainWindow", u"Debug Screen", None))
        self.btn_nav_reports.setText(QCoreApplication.translate("MainWindow", u"R", None))
        self.lbl_nav_reports.setText(QCoreApplication.translate("MainWindow", u"Reports", None))
        self.btn_nav_settings.setText(QCoreApplication.translate("MainWindow", u"S", None))
